        ...
        <div className="bg-bg-surface border border-border-main p-6 rounded-3xl flex flex-col sm:flex-row items-center sm:justify-between gap-4 shadow-sm" id="user-profile-summary">
          <div className="flex items-center space-x-4">
            <div 
              ...
              className="w-14 h-14 rounded-2xl text-white flex items-center justify-center text-2xl font-black font-heading uppercase hover:ring-2 hover:ring-offset-1 hover:ring-offset-bg-surface hover:ring-accent-saffron/40 transition-all cursor-pointer"
            >

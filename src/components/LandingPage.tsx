...
export const LandingPage: React.FC<LandingPageProps> = ({ setView, onBrowseAll, onStartChatWithQuery }) => {
  ...
  return (
    <div className="relative min-h-screen bg-bg-base flex flex-col justify-between" id="landing-container">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#111827_1px,transparent_1px),linear-gradient(to_bottom,#111827_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_40%,#000_70%,transparent_100%)] pointer-events-none z-0" />

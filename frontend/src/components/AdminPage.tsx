...
import { LayoutDashboard, Plus, ArrowLeft, LogOut, Database, Globe, Landmark, AlertCircle } from 'lucide-react';
      ...
      <div className="w-64 border-r border-white/5 bg-[#0d0d0d] flex flex-col justify-between select-none">
        <div>
          ...
          <div className="p-4 space-y-1">
            <button
              className="w-full flex items-center gap-3 px-4 py-3 bg-violet-600/10 border border-violet-500/20 text-violet-300 font-semibold text-xs rounded-xl transition-all cursor-pointer"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="h-16 border-b border-white/5 bg-[#0d0d0d]/80 backdrop-blur-md px-8 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h2 className="text-md font-bold text-white tracking-tight">Scheme Matrix Core</h2>

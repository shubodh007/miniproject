    ...
    <div className="bg-bg-elevated border-2 border-accent-saffron/30 rounded-2xl p-5 shadow-lg space-y-4 max-w-md animate-fade-in" id="eligibility-widget">
      <div className="flex items-center justify-between border-b border-border-subtle pb-3">
        <div className="flex items-center space-x-2">
          ...
          <h4 className="text-xs sm:text-sm font-black text-text-primary uppercase tracking-wider">
            {isTe ? 'అర్హత తనిఖీ సాధనం' : isHi ? 'पात्रता स्व-जांच साधन' : 'Eligibility Self-Checker'}
          </h4>
        </div>
        <span className="text-[11px] leading-tight bg-accent-saffron/10 text-accent-saffron px-2 py-0.5 rounded-full font-bold">
          {scorePercent}% {isTe ? 'సరిపోయింది' : isHi ? 'मेल खाया' : 'Matched'}
        </span>
      </div>
      ...
      <p className="text-[11px] text-text-secondary leading-relaxed font-normal">
        {isTe 
          ...
          : isHi 
          ? 'प्रमुख कल्याणकारी कार्यक्रमों के विरुद्ध पात्रता का मूल्यांकन करने के लिए नीचे दिए गए मानदंडों पर निशान लगाएं:'
      ...
      <div className="space-y-2.5">
        {[
          { key: 'resident', te: 'ఆంధ్రప్రదేశ్ లేదా తెలంగాణ శాశ్వత నివాసి', hi: 'आंध्र प्रदेश या तेलंगाना के स्थायी निवासी', en: 'Permanent Resident of AP or TS' },
          { key: 'bpl', te: 'తెల్ల రేషన్ కార్డ్ లేదా ఆదాయం రూ. 1.2 లక్షల లోపు ఉంది', hi: 'बीपीएल सफेद राशन कार्डधारक या ₹1.2 लाख से कम आय', en: 'BPL White Ration Cardholder' },
          { key: 'age', te: 'కుటుంబంలో 18-60 సంవత్సరాల వయస్సు గల సభ్యులు ఉన్నారు', hi: 'परिवार में 18-60 वर्ष के सक्रिय सदस्य', en: 'Active household ages (18-60 yrs)' },
          { key: 'aadhaar', te: 'ఆధార్ కార్డ్ బ్యాంక్ ఖాతాతో అనుసంధానం చేయబడింది', hi: 'आधार बैंक खाते से लिंक (डीबीटी सक्रिय)', en: 'Aadhaar fully linked to Bank Account (DBT active)' },
          { key: 'nonGovt', te: 'కుటుంబంలో ప్రభుత్వ ఉద్యోగులు గాని, సొంత కారు గాని లేవు', hi: 'परिवार में कोई सरकारी कर्मचारी या चौपहिया वाहन मालिक नहीं', en: 'No govt employees or four-wheeler owners in family' },
        ].map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full p-4 rounded-xl border text-left flex items-start space-x-3 transition-all cursor-pointer ${
                isChecked 
            ...
            >
              <span className="mt-0.5 shrink-0">
                {isChecked ? (
                  <CheckSquare className="text-accent-saffron" size={16} />
                ) : (
                  <Square size={16} />
                )}
              </span>
              <span className="text-[13px] sm:text-[14px] font-semibold leading-relaxed">
                {isTe ? item.te : isHi ? item.hi : item.en}
              </span>
            </button>
          );
        })}
      ...
      <div className="bg-bg-base/60 p-3 rounded-xl border border-border-subtle/50 space-y-2 text-center">
        ...
        {scorePercent === 100 ? (
          <p className="text-[11px] text-success font-black uppercase">
            🎉 {isTe ? 'అన్ని అర్హతలు సరిపోయాయి! అమరావతి సచివాలయంలో నేరుగా అప్లై చేయొచ్చు.' : isHi ? '🎉 पूरी तरह से पात्र! सीधे जिला सचिवालय में ऑनबोर्डिंग के लिए तैयार।' : 'Fully Eligible! Ready for direct Secretariat onboarding.'}
          </p>
        ) : scorePercent >= 60 ? (
          <p className="text-[11px] text-accent-gold font-bold">
            💡 {isTe ? 'పాక్షికంగా సరిపోయింది. ఆదాయం మరియు నివాస దృవీకరణ సరిచూసుకోండి.' : isHi ? '💡 उच्च संभावना! मानक सत्यापन मानदंड पूर्ण होते हैं।' : 'High probability! Standard verification criteria passed.'}
          </p>
        ) : (
          <p className="text-[11px] text-text-muted font-bold">
            ⚠️ {isTe ? 'పథకానికి దరఖాస్తు చేయడానికి కనీసం 3 విభాగాలు అర్హత కలిగి ఉండాలి.' : isHi ? '⚠️ कल्याणकारी योजना अनुपालन का मूल्यांकन करने के लिए चेकबॉक्स को चिह्नित करना जारी रखें।' : 'Keep marking checkboxes to evaluate welfare scheme compliance.'}
          </p>
        )}
      </div>
    </div>
    ...
    <div className="bg-bg-elevated border-2 border-accent-blue/30 rounded-2xl p-5 shadow-lg space-y-4 max-w-md animate-fade-in" id="calculator-widget">
      <div className="flex items-center justify-between border-b border-border-subtle pb-3">
        <div className="flex items-center space-x-2">
          ...
          <h4 className="text-xs sm:text-sm font-black text-text-primary uppercase tracking-wider">
            {isTe ? 'వ్యవసాయ పెట్టుబడి కాలిక్యులేటర్' : isHi ? 'कृषि निवेश सहायता कैलकुलेटर' : 'Seasonal Welfare Payout Calculator'}
          </h4>
        </div>
        <span className="text-[11px] leading-tight bg-accent-blue/10 text-accent-blue px-2.5 py-0.5 rounded-full font-bold">
          {isTe ? 'లైవ్ గణన' : isHi ? 'द्वि-वार्षिक अनुमान' : 'Bi-Annual Projections'}
        </span>
      </div>
      ...
      <div className="space-y-1.5">
        <label className="text-[11px] leading-tight font-black uppercase text-text-muted tracking-wide">
          {isTe ? 'రైతు పథకాన్ని ఎంచుకోండి:' : isHi ? 'कृषि सहायता कार्यक्रम चुनें:' : 'Select Farming Assistance Program:'}
        </label>
        <div className="grid grid-cols-3 gap-1.5" id="calc-scheme-tabs">
          {[
            { id: 'rythu_bharosa', te: 'రైతు భరోసా', hi: 'रैतु भरोसा', en: 'Rythu Bharosa' },
            { id: 'rythu_bandhu', te: 'రైతు బంధు', hi: 'रैतु बंधु', en: 'Rythu Bandhu' },
            { id: 'pm_kisan', te: 'PM కిసాన్', hi: 'पीएम किसान', en: 'PM Kisan' },
          ].map((item) => (
            <button
              key={item.id}
              onClick={() => setScheme(item.id as any)}
              className={`py-3 px-2 text-xs font-black uppercase tracking-wider rounded-lg text-center border cursor-pointer transition-all ${
                scheme === item.id 
      ...
      {flatBenefit === 0 ? (
        <div className="space-y-2">
          <div className="flex justify-between items-center text-[11px] leading-tight font-black uppercase text-text-secondary">
            <span>{isTe ? 'సాగు భూమి వైశాల్యం (ఎకరాలలో):' : isHi ? 'खेती के अधीन भूमि क्षेत्र (एकड़ में):' : 'Land acreage under cultivation:'}</span>
            <span className="text-accent-blue text-xs font-black bg-accent-blue/10 px-2 py-0.5 rounded">
              {acres} {isTe ? 'ఎకరాలు' : isHi ? 'एकड़' : 'Acres'}
            </span>
          </div>
          <input 
            type="range" 
        ...
        <div className="p-3 bg-bg-base rounded-xl border border-border-subtle text-center text-[11px] leading-tight font-bold text-text-secondary">
          📌 {isTe ? 'పి.ఎం కిసాన్ పథకం సాగు భూమి వైశాల్యంతో సంబంధం లేకుండా సంవత్సరానికి స్థిరంగా ₹6,000 చెల్లిస్తుంది.' : isHi ? '📌 पीएम-किसान सभी पात्र पंजीकृत किसानों को सालाना ₹6,000 का निश्चित वित्तीय प्रोत्साहन प्रदान करता है।' : 'PM-KISAN pays a guaranteed flat incentive of ₹6,000 annually to all eligible registered pathholders.'}
        </div>
      )}
      ...
      <div className="bg-gradient-to-br from-bg-base to-bg-surface border border-border-strong rounded-2xl p-4 text-center space-y-2">
        <p className="text-[11px] leading-tight font-black text-text-muted uppercase tracking-wider">
          {isTe ? 'మొత్తం వార్షిక ఊహిత పెట్టుబడి సాయం' : isHi ? 'अनुमानित कुल वार्षिक सहायता भुगतान' : 'Projected Total Annual Payout'}
        </p>
        ...
        <div className="border-t border-border-subtle/50 my-2 pt-2 grid grid-cols-2 gap-2 text-left">
          <div>
            <p className="text-[11px] leading-tight font-black text-text-muted uppercase">{isTe ? 'వాయిదాల సంఖ్య' : isHi ? 'किस्त आवृत्ति' : 'Installments'}</p>
            <p className="text-xs font-bold text-text-secondary">{installments} {isTe ? 'విడతలు / సంవత్సరం' : isHi ? 'किस्त / वर्ष' : 'Tranches / Year'}</p>
          </div>
          <div>
            <p className="text-[11px] leading-tight font-black text-text-muted uppercase">{isTe ? 'చేపట్టే ఒక విడత నిధులు' : isHi ? 'प्रति किस्त राशि' : 'Amount Per Tranche'}</p>
            <p className="text-xs font-black text-success">₹{perInstallment.toLocaleString('en-IN')}</p>
          </div>
        </div>
      </div>
    </div>
...
export function PaymentStatusTracker({ language }: LanguageProp) {
  ...
  const handleTrack = (e: React.FormEvent) => {
    ...
    if (aadhaar.replace(/\s/g, '').length !== 12) {
      alert(isTe ? 'దయచేసి సరైన 12 అంకెల ఆధార్ సంఖ్యను ప్రవేశపెట్టండి' : isHi ? 'कृपया एक वैध 12-अंकीय आधार संख्या दर्ज करें' : 'Please provide a valid 12-digit Aadhaar Number');
      return;
    }
    ...
    setTimeout(() => {
      ...
      setTrackedData({
        ...
        status: isTe ? 'ఆమోదించబడింది & బదిలీ చేయబడింది' : isHi ? 'स्वीकृत और भेजा गया' : 'APPROVED & DISPATCHED',
        date: isTe ? 'మే 18, 2026' : isHi ? '18 मई, 2026' : 'May 18, 2026',
  ...
  return (
    <div className="bg-bg-elevated border-2 border-accent-gold/30 rounded-2xl p-5 shadow-lg space-y-4 max-w-md animate-fade-in" id="payment-tracker-widget">
      <div className="flex items-center justify-between border-b border-border-subtle pb-3">
        <div className="flex items-center space-x-2">
          <RefreshCw className="text-accent-gold" size={17} />
          <h4 className="text-xs sm:text-sm font-black text-text-primary uppercase tracking-wider">
            {isTe ? 'లైవ్ సాయం బదిలీ స్టేటస్' : isHi ? 'वास्तविक समय डीबीटी भुगतान ट्रैकर' : 'Real-time DBT Payment Tracker'}
          </h4>
        </div>
        <span className="text-[11px] leading-tight bg-accent-gold/10 text-accent-gold px-2.5 py-0.5 rounded-full font-bold">
          {isTe ? 'ట్రెజరీ సర్వర్' : isHi ? 'एनआईसी रिकॉर्ड' : 'NIC Ledger Link'}
        </span>
      </div>
      ...
      <form onSubmit={handleTrack} className="space-y-3">
        <div className="space-y-1">
          <label className="text-[11px] leading-tight font-black uppercase text-text-muted tracking-wide">
            {isTe ? 'పథకాన్ని ఎంచుకోండి:' : isHi ? 'पूछताछ के लिए योजना चुनें:' : 'Select Scheme to Query:'}
          </label>
          <select 
            value={scheme} 
            onChange={(e) => setScheme(e.target.value)}
            className="w-full bg-bg-base border border-border-subtle p-2.5 rounded-xl text-xs font-bold text-text-primary focus:outline-none"
          >
            <option value="pm_kisan">PM-KISAN (₹6,000)</option>
            <option value="talliki_vandanam">Talliki Vandanam / Amma Vodi (₹15,000)</option>
            <option value="rythu_bharosa">Rythu Bharosa / Assistance (₹12,000)</option>
          </select>
        </div>

        <div className="space-y-1">
          <label className="text-[11px] leading-tight font-black uppercase text-text-muted tracking-wide">
            {isTe ? 'ఆధార్ నంబర్ ప్రవేశపెట్టండి (12 అంకెలు):' : isHi ? '12-अंकीय आधार पहचानकर्ता दर्ज करें:' : 'Enter 12-Digit Aadhaar Identifier:'}
          </label>
          <input 
            type="text" 
        ...
        >
          {loading ? (
            <>
              ...
              <span>{isTe ? 'ట్రెజరీ లెడ్జర్ శోధిస్తోంది...' : isHi ? 'डीबीटी रिकॉर्ड सिंक किया जा रहा है...' : 'Syncing DBT Ledger Database...'}</span>
            </>
          ) : (
            <span>{isTe ? 'సమీక్షించు / స్థితి తనిఖీ' : isHi ? 'भुगतान लेजर जांचें' : 'Verify & Poll Payment Ledger'}</span>
          )}
        </button>
      </form>
      ...
      {trackedData && (
        <div className="p-4 bg-success/5 border border-success/35 rounded-2xl space-y-3 animate-fade-in" id="dbt-tracking-results">
          <div className="flex items-center justify-between border-b border-success/20 pb-2">
            <span className="text-[11px] leading-tight font-black text-success uppercase tracking-wide">
              {isTe ? 'ట్రాకింగ్ ఫలశ్రుతి:' : isHi ? 'डीबीटी भुगतान रिकॉर्ड:' : 'DBT Transaction Ledger:'}
            </span>
            <span className="px-2 py-0.5 bg-success/10 text-success font-black text-[11px] leading-tight rounded-full">
              {trackedData.status}
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-[11px] leading-tight font-bold">
            <div>
              <p className="text-[11px] leading-tight font-black text-text-muted uppercase">{isTe ? 'విరాళం మొత్తం' : isHi ? 'हस्तांतरित राशि' : 'Amount Transferred'}</p>
              <p className="text-sm font-black text-text-primary">{trackedData.amount}</p>
            </div>
            <div>
              <p className="text-[11px] leading-tight font-black text-text-muted uppercase">{isTe ? 'లావాదేవీ తేదీ' : isHi ? 'भुगतान तिथि' : 'Transfer Date'}</p>
              <p className="text-xs text-text-secondary">{trackedData.date}</p>
            </div>
            <div>
              <p className="text-[11px] leading-tight font-black text-text-muted uppercase">{isTe ? 'చెల్లింపు జరిగిన బ్యాంకు' : isHi ? 'नोडल बैंक खाता' : 'Nodal Bank Account'}</p>
              <p className="text-[11px] leading-tight text-text-secondary truncate">{trackedData.bank} (*{trackedData.acEnding})</p>
            </div>
            <div>
              <p className="text-[11px] leading-tight font-black text-text-muted uppercase">{isTe ? 'ప్రభుత్వ సూచన సంఖ్య' : isHi ? 'सरकारी संदर्भ संख्या' : 'Govt Reference Id'}</p>
...
export function SchemeComparison({ language }: LanguageProp) {
  ...
  const categories = [
    { id: 'benefit', te: 'సహాయ ధనం', hi: 'वार्षिक सहायता धन', en: 'Payout Volume' },
    { id: 'tranches', te: 'విడతల క్రమం', hi: 'किस्त आवृत्ति', en: 'Installment Frequency' },
    { id: 'eligibility', te: 'పట్టా అర్హత', hi: 'पट्टा स्वामित्व नियम', en: 'Owner Tenancy Rules' },
    { id: 'exclusions', te: 'నిषेధాలు', hi: 'अयोग्यता मानदंड', en: 'Disbarment Metrics' },
  ];

  return (
    <div className="bg-bg-elevated border-2 border-success/30 rounded-2xl p-5 shadow-lg space-y-4 max-w-lg overflow-hidden animate-fade-in" id="comparison-widget">
      <div className="flex items-center justify-between border-b border-border-subtle pb-3">
        <div className="flex items-center space-x-2">
          <ArrowUpDown className="text-success" size={18} />
          <h4 className="text-xs sm:text-sm font-black text-text-primary uppercase tracking-wider">
            {isTe ? 'వ్యవసాయ పథకాల పోలిక' : isHi ? 'किसान सहायता योजनाओं की तुलना' : 'Farmer Assistance Scheme Head-to-Head'}
          </h4>
        </div>
        <span className="text-[11px] leading-tight bg-success/15 text-success px-2.5 py-0.5 rounded-full font-bold">
          {isTe ? 'పక్క పక్క పోలిక' : isHi ? 'आमने-सामने तुलना' : 'Side-By-Side Comparison'}
        </span>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3.5 border-t border-border-subtle/40 pt-3.5">
        ...
        <div className="space-y-2.5 p-3 rounded-2xl bg-bg-base border border-border-subtle flex flex-col justify-between">
          <div>
            <div className="flex items-center space-x-1.5 border-b border-border-subtle/50 pb-1.5">
              <Building2 size={13} className="text-success shrink-0" />
              <span className="text-[11px] leading-tight font-black text-text-primary uppercase truncate">PM Kisan</span>
            </div>
            <p className="text-[11px] leading-tight font-bold text-text-muted uppercase tracking-wide mt-1">{isTe ? 'కేంద్ర పథకం' : isHi ? 'केंद्रीय सरकारी योजना' : 'Central Scheme'}</p>
          </div>
          ...
          <div className="py-2">
            {metric === 'benefit' && (
              <div className="space-y-1">
                ...
                <p className="text-[11px] leading-tight text-text-secondary leading-normal">{isTe ? 'భూమి విస్తీర్ణంతో నిమిత్తం లేకుండా దేశవ్యాప్తంగా స్థిర సాయం.' : isHi ? 'बिना किसी भूमि जोत सीमा के पूरे भारत में समान रूप से दी जाने वाली निश्चित सहायता राशि।' : 'Fixed relief incentive distributed equally without landholding limits.'}</p>
              </div>
            )}
            {metric === 'tranches' && (
              <div className="space-y-1">
                <p className="text-sm font-black text-text-primary">{isTe ? '3 వాయిదాలు' : isHi ? '3 किस्तें' : '3 Installments'}</p>
                <p className="text-[11px] leading-tight text-success font-bold">₹2,000 + ₹2,000 + ₹2,000</p>
                <p className="text-[11px] leading-tight text-text-secondary leading-normal">{isTe ? 'నగదు నేరుగా నాలుగు నెలలకు ఒకసారి ఆధార్ లింక్డ్ బ్యాంక్ ఖాతాలో జమ.' : isHi ? 'हर 4 महीने में सीधे आधार लिंक बैंक खाते में ऑनलाइन ट्रांसफर की जाती है।' : 'Disbursed every 4 months directly through PFMS router nodes.'}</p>
              </div>
            )}
            {metric === 'eligibility' && (
              <div className="space-y-1">
                <p className="text-sm font-black text-text-primary">{isTe ? 'పట్టాదారు రైతుకు మాత్రమే' : isHi ? 'केवल भूमिधारी मालिक' : 'Landholding Owners Only'}</p>
                <p className="text-[11px] leading-tight text-text-secondary leading-normal">{isTe ? 'కచ్చితంగా పట్టా పాస్ బుక్ కలిగి ఉండాలి. కౌలు రైతులకు లబ్ధి చేకూరదు.' : isHi ? 'पट्टा पास बुक होना अनिवार्य है। बटाईदार या किरायेदार किसान इसके पात्र नहीं हैं।' : 'Must hold active Pattadar land deeds. Tenant farmers and oral lessees are excluded.'}</p>
              </div>
            )}
            {metric === 'exclusions' && (
              <div className="space-y-1">
                <p className="text-[11px] leading-tight text-error font-extrabold uppercase">{isTe ? '🚫 పన్నుదారులకు వర్తించదు' : isHi ? '🚫 करदाता और सरकारी नौकरी' : '🚫 Taxpayers & Govt Jobholders'}</p>
                <p className="text-[11px] leading-tight text-text-secondary leading-normal">{isTe ? 'ఆధాయ పన్ను చెల్లించేవారు, వ్యవసాయేతర స్థలాలు గలవారు అనర్హులు.' : isHi ? 'संस्थागत भूमि स्वामी, सेवानिवृत्त या कार्यरत करदाता सरकारी कर्मचारी बाहर हैं।' : 'Institutional landowners, serving officers, and tax filing groups are barred.'}</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="space-y-2.5 p-3 rounded-2xl bg-bg-base border border-border-subtle flex flex-col justify-between">
          <div>
            ...
            <p className="text-[11px] leading-tight font-bold text-accent-saffron uppercase tracking-wide mt-1">{isTe ? 'రాష్ట్ర పథకం (AP/TS)' : isHi ? 'राज्य सरकार योजना (AP/TS)' : 'State Scheme (AP/TS)'}</p>
          </div>
          ...
          <div className="py-2">
            {metric === 'benefit' && (
              <div className="space-y-1">
                ...
                <p className="text-[11px] leading-tight text-text-secondary leading-normal">{isTe ? 'తెలంగాణ మరియు ఆంధ్రాలో ఏడాదికి ఎకరాకు ₹10,000 - ₹12,000 సాయం.' : isHi ? 'प्रति एकड़ सहायता। तेलंगाना में ₹10,000 जबकि आंध्र प्रदेश में ₹12,000 सालाना।' : 'Calculated per acre; Telangana pays ₹10,000, Andhra paying ₹12,000.'}</p>
              </div>
            )}
            {metric === 'tranches' && (
              <div className="space-y-1">
                <p className="text-sm font-black text-text-primary">{isTe ? '2 వాయిదాలు' : isHi ? '2 किस्तें' : '2 Installments'}</p>
                <p className="text-[11px] leading-tight text-accent-saffron font-bold">{isTe ? 'ఖరీఫ్ & రబీ సీజన్లు' : isHi ? 'खरीफ और रबी फसल का मौसम' : 'Kharif & Rabi Seasons'}</p>
                <p className="text-[11px] leading-tight text-text-secondary leading-normal">{isTe ? 'వానాకాలం మరియు యాసంగి పంటలు వేసే మునుపు నేరుగా జమ.' : isHi ? 'बुवाई चक्र शुरू होने पर बीज और रासायनिक खादों की खरीद हेतु सीधे हस्तांतरित।' : 'Distributed at the start of sowing cycles to fund seeds and fertilizers.'}</p>
              </div>
            )}
            {metric === 'eligibility' && (
              <div className="space-y-1">
                <p className="text-sm font-black text-text-primary">{isTe ? 'కౌలు రైతులకు కూడా వర్తిస్తుంది' : isHi ? 'बटाईदार किसान भी' : 'Cover Tenant Farmers'}</p>
                <p className="text-[11px] leading-tight text-text-secondary leading-normal">{isTe ? 'సీసీఆర్‌సీ కార్డ్ (CCRC Card) కలిగిన కౌలు రైతులకు పధకం లభిస్తుంది.' : isHi ? 'सीसीआरसी (CCRC) कार्ड धारक पंजीकृत बटाईदार और किरायेदार किसान भी पात्र हैं।' : 'Valid for landholders AND registered tenant farmers holding CCRC cards.'}</p>
              </div>
            )}
            {metric === 'exclusions' && (
              <div className="space-y-1">
                <p className="text-[11px] leading-tight text-error font-extrabold uppercase">{isTe ? '🚫 గరిష్ట పరిమితి ఉంది' : isHi ? '🚫 बड़े कॉरपोरेट्स के लिए सीमा' : '🚫 Large Corporates Capped'}</p>
                <p className="text-[11px] leading-tight text-text-secondary leading-normal">{isTe ? 'గరిష్టంగా 15-20 ఎకరాల లోపు వారికి మాత్రమే సాయం పరిమితం.' : isHi ? 'कल्याणकारी सहायता अनुचित कॉर्पोरेट दुरुपयोग से बचने के लिए अधिकतम 15-20 एकड़ तक सीमित है।' : 'Capped up to a sliding ceiling of 15-20 acres to avoid corporate pooling.'}</p>
              </div>
            )}
          </div>
        </div>
  ...
  return (
    <div className="bg-bg-elevated border-2 border-accent-saffron/30 rounded-2xl p-5 shadow-lg space-y-4 max-w-md animate-fade-in" id="document-checklist-widget">
          ...
          return (
            <button
              ...
              className={`w-full p-2.5 rounded-xl border text-left flex items-start space-x-3 transition-all cursor-pointer ${
                isChecked 
                  ? 'bg-accent-saffron/5 border-success/50 text-text-primary' 
                  : 'bg-bg-base hover:bg-bg-surface border-border-subtle text-text-muted hover:text-text-secondary'
              }`}
            >
              <span className="mt-0.5 shrink-0">
      ...
      <div className="p-3 bg-bg-base rounded-xl border border-border-subtle flex items-center justify-between">
        ...
        <span className={`text-[11px] leading-tight font-black uppercase ${isCompleted ? 'text-success' : 'text-accent-gold'}`}>
